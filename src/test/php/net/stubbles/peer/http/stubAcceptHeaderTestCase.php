<?php
/**
 * Test for net::stubbles::peer::http::stubAcceptHeader.
 *
 * @package     stubbles
 * @subpackage  peer_http_test
 * @version     $Id: stubAcceptHeaderTestCase.php 2446 2010-01-11 21:59:50Z mikey $
 */
stubClassLoader::load('net::stubbles::peer::http::stubAcceptHeader');
/**
 * Test for net::stubbles::peer::http::stubAcceptHeader.
 *
 * @package     stubbles
 ...
 * @group       peer_http
 */
class stubAcceptHeaderTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * instance to test
     *
     * @var  stubAcceptHeader
     */
    ...
    {
        $this->acceptHeader = new stubAcceptHeader();
    }
    ...
    {
        $acceptHeader = stubAcceptHeader::parse($parseValue);
